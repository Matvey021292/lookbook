...
/* harmony import */ var _tarekraafat_autocomplete_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @tarekraafat/autocomplete.js */ "./node_modules/@tarekraafat/autocomplete.js/dist/js/autoComplete.min.js");
...
glides.forEach(function (e, i) {
  var glides_slide = e.getAttribute('data-slide-count') || 7;
  ...
  new _glidejs_glide__WEBPACK_IMPORTED_MODULE_1__["default"](e, {
...
new _tarekraafat_autocomplete_js__WEBPACK_IMPORTED_MODULE_2___default.a({
  data: {
    src: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return fetch("".concat(ajax_login_object.search_url, "?search=").concat(query));
  ...
  resultItem: {
    content: function content(data, source) {
      ...
      if (data.value.File) {// picture = "<img class='autoComplete_picture' src='" + data.value.File + "'></img>";
      }

      if (data.value.FileAuthor) {
        item = "<span class='test_sm'>" + data.value.FileAuthor + "</span>";
      } else {
        item = "<span class='test_sm'>" + data.value.key + "</span>";
      }

      source.innerHTML = picture + "<div>" + data.match + item + "</div>";
    },
    element: "li"
  },
...
function requestPostData(_x, _x2) {
  return _requestPostData.apply(this, arguments);
}

function _requestPostData() {
  _requestPostData = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(route, data) {
    var meta, response;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            meta = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
            _context2.next = 3;
            return fetch(route, {
              method: 'POST',
              headers: {
...
function showLoader(el) {
  ...
  if (el) content = el;
  var loader = content.querySelector('.loader');
...
var collapse_btn = document.querySelectorAll('*[data-toggle="collapse"] .toggle-icon');
...
document.querySelectorAll('form.ajax').forEach(function (element) {
  element.addEventListener('submit', function (e) {
    ...
    showLoader(element);
    requestPost(this.action, formData).then(function (data) {
      ...
      setTimeout(function () {
        ...
        for (var fields in data.message.field) {
          var field = element.querySelector("input[name='".concat(fields, "']"));
...
function appendMessage(element, status, message) {
  var row = element.closest('.Form__formRow');
  row.classList.add(status);
  row.appendChild(createMessage(status, message));
}

function removeMessage(element) {
  var row = element.closest('.ajax');
  ...
  var msg = row.querySelectorAll('.ValidationMessage');
...
function createMessage(status, messages) {
  ...
  msg.classList.add("".concat(status), "ValidationMessage");
  var message = '';
  messages.forEach(function (e) {
    message += "<span>".concat(e, "</span>");
  });
  msg.innerHTML = message;
  return msg;
}

function requestPost(_x3, _x4) {
  return _requestPost.apply(this, arguments);
}

function _requestPost() {
  _requestPost = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(route, data) {
    var meta, response;
...
var filter_input = document.querySelector('.select');
...
if (filter_input) {
  filter_input.addEventListener('change', function (e) {
    ...
    showLoader(body);
    requestPost(form.action, formData).then(function (data) {
      if (data.status == 'success') {
...
function add_params_url() {
  ...
  if (location.search(regexp) !== -1) {
    location = location.replace(regexp, ''); // location += '?' + $.param(params);
...
var observer = new IntersectionObserver(function (entries) {
  ...
  if (entries[0].intersectionRatio === 0) document.querySelector("#nav-container").classList.add("nav-container-sticky"); // fully intersects with screen
  else if (entries[0].intersectionRatio === 1) document.querySelector("#nav-container").classList.remove("nav-container-sticky");
}, {
  threshold: [0, 1]
});
...
/***/ 0:
/*!****************************************!*\
  !*** multi ./public/book/js/common.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
