jQuery(document).ready(function($) {
    //Labels or Place Holder.
    if (jsPassData.display_labels == 'Placeholders') {
        $(".cover_modal").find("label").css("display", "none");
        $(".validate_alert").show();
        $("#lb_rememberme").show();
        $(".cover_modal").find("#login_user").attr("placeholder", "Username");
        $(".cover_modal").find("#pass_user").attr("placeholder", "Password");
        $(".cover_modal").find("#register_user").attr("placeholder", "Username");
        $(".cover_modal").find("#register_email").attr("placeholder", "E-mail");
        $(".cover_modal").find("#register_pass").attr("placeholder", "Password");
        $(".cover_modal").find("#confirm_pass").attr("placeholder", "Confirm Password");
        $(".cover_modal").find("#lost_pwd_user_email").attr("placeholder", "E-mail Adress");
    }
    ...
    $(".go_to_login_link").click(function(e) {
        if (jsPassData.type_modal != 'LinkToDefault') {
            ...
            if ($(".cover_modal").css("display") == "none") {
                var windowsize = $(window).width();
                if (jsPassData.type_modal == 'Dropdown') {
                    $(".cover_modal").css('position', 'absolute');
                    $(".cover_modal").css('top', offset.top + 30);
                    $(".cover_modal").css('left', offset.left);
                    if (windowsize < 500) {
                        $(".cover_modal").css('width', '90%');              
                    }
                    if (500 < windowsize < 900) {
                        $(".cover_modal").css('width', '50%');         
                    }
                    if (windowsize > 900) {
                        $(".cover_modal").css('width', '25%');      
                    }
                }

                if (jsPassData.type_modal == 'Popup') {
                    $(".cover_modal").css('width', '100%');
                    $(".cover_modal").css('position', 'fixed');
                    $(".cover_modal").css('top', '0');
                    $(".cover_modal").css('right', '0');
                    $(".cover_modal").css('bottom', '0');
                    $(".cover_modal").css('left', '0');
                    $(".cover_modal").css('padding-top', '3%');
                    if (windowsize < 500) {
                        $(".cover_modal").css('padding-left', '8%');
                        $(".cover_modal").css('padding-right', '8%');              
                    }
                    if (500 < windowsize < 900) {
                        $(".cover_modal").css('padding-left', '16%');
                        $(".cover_modal").css('padding-right', '16%');              
                    }
                    if (windowsize > 900) {
                        $(".cover_modal").css('padding-left', '32%');
                        $(".cover_modal").css('padding-right', '32%');              
                    }
                }

                $(".cover_modal").slideToggle(250);
                $(".login_form").show();
                $("#login_user").focus();
                $(".register_form").hide();
                $(".lost_pwd_form").hide();
