                ...
                <form method="POST" class="ajax" action="{{ route('auth') }}">
                    ...
                    <div class="form-group  Form__formRow jest-auth-email">
                        <span class="FormTextInput__formTextInput">
                            <label for="email"
                                   class="FormTextInput__label  col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                            <div class="FormTextInput__control">
                                <input id="email" type="email"
                                       class="FormTextInput__input form-control @error('email') is-invalid @enderror"
                    ...
                    <div class="form-group Form__formRow">
                        <span class="FormTextInput__formTextInput">
                            <label for="password"
                                   class="FormTextInput__label col-form-label text-md-right">{{ __('Password') }}</label>
                            <div class="FormTextInput__control">
                                <input id="password" type="password"
                                       class="FormTextInput__input form-control @error('password') is-invalid @enderror"
